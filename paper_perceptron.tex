...
La Figura~\ref{fig:arquitectura} resume el flujo general del experimento aplicado en los
cuatro lenguajes del proyecto.

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figuras/fig_arquitectura_perceptron.png}
\caption{Arquitectura general del flujo de entrenamiento, prediccion y evaluacion del perceptron.}
...
Como evidencia visual de convergencia, la Figura~\ref{fig:ecm_python} muestra las curvas
de error cuadratico medio para los seis casos en Python.
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figuras/fig_ecm_python_panel.png}
\caption{Panel de curvas ECM por caso en la implementacion Python.}
\label{fig:ecm_python}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figuras/fig_accuracy_multilenguaje.png}
\caption{Comparacion visual de accuracy entre Python, Java y JavaScript.}
\label{fig:acc_multi}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figuras/fig_precision_recall_multilenguaje.png}
\caption{Precision y recall por caso para Java y JavaScript.}
\label{fig:pr_multi}
\end{figure}
